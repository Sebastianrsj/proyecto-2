...
def checkbox_clicked():
    ...
    valorpreguntas = 0
    if valor == 0:
        messagebox.showerror("Advertencia", "Por favor seleccione una opción")
    if valor == 1:
...
def delete3():
    ...
    boton_sugerencias = Button(otra_ventana2,text = "Resumen", width = "10", height = "2", command=funsuger , bg = "burlywood", font = ("Times",16, "bold"))
    boton_sugerencias.place(x = 300, y = 430)
    atrventana3(total)
    
#   Funciones de carreras sugeridas por el programa----------------------------------------
